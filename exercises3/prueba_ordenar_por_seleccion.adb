...
with Ordenar_Por_Seleccion, Escribir_Lista;

procedure Prueba_Ordenar_Por_Seleccion is 
   -- este programa hace llamadas al subprograma ordenar_por_selección
...
end Prueba_Ordenar_Por_Seleccion;
